...
Page({
  ...
  getWeather(city) {
    ...
    //获取实况天气
    wx.request({
      url: 'https://free-api.heweather.net/s6/weather/now?key=e6ecc6dd65074aa68e62731f2dc7b56c&location=' + city,
      success: function(res) {
        ...
        //获取24小时天气预报
        wx.request({
          url: 'https://free-api.heweather.net/s6/weather/hourly?key=e6ecc6dd65074aa68e62731f2dc7b56c&location=' + city,
          success: function(res) {
            ...
            //获取未来7天天气预报
            wx.request({
              url: 'https://free-api.heweather.net/s6/weather/forecast?key=e6ecc6dd65074aa68e62731f2dc7b56c&location=' + city,
